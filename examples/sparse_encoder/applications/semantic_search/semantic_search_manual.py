...
for query_id, query in enumerate(queries):
    ...
    for corpus_id, score in zip(indices[query_id].tolist(), scores[query_id]):
        ...
        top_tokens = [(token, round(value, 2)) for token, value in zip(top_tokens, top_values.tolist())]
...
Score: 10.2556 - Sentence: A man is riding a horse. - Top influential tokens: [('man', 4.85), ('men', 3.11), ('male', 0.68), ('a', 0.6), ('person', 0.59), ('animal', 0.21), ('god', 0.08), ('adam', 0.08), ('sex', 0.03), ('who', 0.01)]
...
Score: 5.2575 - Sentence: Two men pushed carts through the woods. - Top influential tokens: [('men', 2.6), ('man', 2.51), ('a', 0.12), ('murder', 0.01), ('.', 0.01), ('said', 0.0), ('[unused1]', 0.0), ('[unused2]', 0.0), ('[unused0]', 0.0), ('[PAD]', 0.0)]

Query: Someone in a gorilla costume is playing a set of drums.
Score: 16.7709 - Sentence: A monkey is playing drums. - Top influential tokens: [('drums', 4.38), ('drum', 2.27), ('play', 2.16), ('playing', 1.77), ('drummer', 0.8), ('dance', 0.67), ('monkey', 0.55), ('music', 0.5), ('a', 0.4), ('sound', 0.39)]
...
Score: 2.8393 - Sentence: A man is riding a horse. - Top influential tokens: [('person', 0.91), ('a', 0.49), ('man', 0.45), ('animal', 0.37), ('sport', 0.32), ('savage', 0.1), ('dance', 0.08), ('billy', 0.06), ('god', 0.04), ('hunting', 0.01)]
Score: 2.4528 - Sentence: A man is eating a piece of bread. - Top influential tokens: [('person', 0.9), ('man', 0.45), ('a', 0.42), ('someone', 0.29), ('animal', 0.08), ('god', 0.07), ('ritual', 0.07), ('culture', 0.07), ('something', 0.05), ('who', 0.03)]
...
Score: 16.4271 - Sentence: A cheetah is running behind its prey. - Top influential tokens: [('che', 3.8), ('##eta', 3.72), ('prey', 2.77), ('hunting', 0.75), ('behavior', 0.7), ('##h', 0.62), ('movement', 0.45), ('animal', 0.33), ('predator', 0.3), ('chasing', 0.29)]
...
Score: 1.5377 - Sentence: A man is riding a horse. - Top influential tokens: [('a', 0.51), ('animal', 0.48), ('movement', 0.33), ('sport', 0.16), ('hunting', 0.04), ('dance', 0.02), ('[unused1]', 0.0), ('[unused2]', 0.0), ('[unused0]', 0.0), ('[PAD]', 0.0)]
Score: 1.4831 - Sentence: A man is riding a white horse on an enclosed ground. - Top influential tokens: [('a', 0.43), ('animal', 0.35), ('hunting', 0.21), ('movement', 0.17), ('sport', 0.13), ('breed', 0.12), ('bird', 0.04), ('dog', 0.02), ('[PAD]', 0.0), ('[unused0]', 0.0)]
Score: 1.4279 - Sentence: Two men pushed carts through the woods. - Top influential tokens: [('hunting', 0.49), ('cross', 0.41), ('move', 0.22), ('a', 0.1), ('escape', 0.08), ('they', 0.06), ('across', 0.05), ('obstacle', 0.01), ('deer', 0.01), ('[PAD]', 0.0)]
"""
