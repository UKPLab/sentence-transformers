...
train_corpus = "datasets/parallel-sentences.tsv.gz"         # Transcripts of TED talks, crawled 2020
sts_corpus = "datasets/stsbenchmark.zip"                    # Extended STS2017 dataset for more languages
